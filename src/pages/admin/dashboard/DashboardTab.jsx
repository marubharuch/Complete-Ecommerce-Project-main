...
import Modal from '../../productInfo/ProductDetail';

function DashboardTab() {
    const context = useContext(myContext)
    const { mode, product, product2, searchkey, setSearchkey, filterType, edithandle, deleteProduct, order, user,handleOpen,handleClose,isOpen } = context
    ...
    return (
        <>
            ...
            <div className="container mx-auto">
                <div>Dashboard tab</div>
                <button type="button" className="btn btn-primary" onClick={() => handleOpen(true)}>Open Modal</button>
      {isOpen && <Modal onClose={() => handleOpen(false)}>This is the modal content.</Modal>}
                            ...
                            <div className='  px-4 md:px-0 mb-16'>
                                ...
                                <div className="relative overflow-x-auto ">
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                                        ...
                                        {product2
                                            .filter((obj) => obj.toLowerCase().includes(searchkey))
