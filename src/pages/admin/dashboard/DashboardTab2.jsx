...
function DashboardTab() {
    ...
    const { mode, product,product2, edithandle, deleteProduct, order, user } = context

    // console.log(product)   file for admin all product list add update delete
...
{/* link  and click event both are presents here */}
